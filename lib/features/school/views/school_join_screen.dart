...
class SchoolJoinScreen extends StatelessWidget {
  static const route = 'SchoolJoinScreen';

  const SchoolJoinScreen({super.key});
            ...
            child: Column(
              children: [
                ...
                const CustomTextField(
                  text: 'Nhập mã trường học',
                ),
                const SizedBox(height: kMarginLg),
                const CustomButton(
                  text: 'Tham gia trường',
                ),
              ],
            ),
          ),
